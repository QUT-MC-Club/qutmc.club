...
<CardGrid stagger>
    ...
    ![Minigames Menu](../../assets/cards/minigames.gif)
    ...
    ![Survival World](../../assets/cards/survival.png)
    ...
    ![Low Ping Image](../../assets/cards/ping.png)
  ...
  <Card title="In Person Events" icon="star">
    <video autoplay loop muted src="src/assets/cards/steve.webm" />
